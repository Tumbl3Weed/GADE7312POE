...
enum Camera_Movements FORWARD, BACKWARD, LEFT, RIGHT;
...
public:
	...
	// Processes input received from any keyboard-like input system. Accepts input parameter in the form of camera defined ENUM(toabstract it from windowing systems)
	...
	void updateCameraVectors()
	{
		...
		this->front = glm::normalize(front); // Also re-calculate the Right and Up vector 
